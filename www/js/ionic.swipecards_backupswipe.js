...
(function(ionic) {
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    // Rotate anchored to the right of the screen
    ...
    _doDragStart: function(e) {
      ...
      var distance = point - e.gesture.touches[0].pageX;// - window.innerWidth/2);
